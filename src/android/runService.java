...
public class runService extends Service {
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    // Keep existing behavior, but don't block foreground start on it.
      ...
      handler.post(new Runnable() {
        ...
        public void run() {
          try {
            ...
            Log.w("Background App Run", "Ignore battery optimizations request failed", e);
          }
        }
      });
    } catch (Exception e) {
      Log.w("Background App Run", "Failed scheduling battery optimization request", e);
    }
  }
